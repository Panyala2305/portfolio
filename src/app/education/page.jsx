...
import graduationImage from '@/images/graduation1.jpg';
    ...
    >
      ...
      <div className="space-y-20">
        <ToolsSection title="Bachelor's Degree">
          <Tool title="CHANDIGARH UNIVERSITY">
            I completed my Bachelor’s degree in Mechatronics at Sastra Deemed
            University , with CGPA OF 7.23, from 2019 to 2023, located in
            Chandigarh.
          </Tool>
        </ToolsSection>
        ...
        <ToolsSection title="10th-Standard">
          <Tool title="Sri Chaithanya e-Techno Schools">
            ...
            E-Techno Schools in Siddipet, Telangana, with a CGPA of 9.7, and
            passed in 2016.
          </Tool>
        </ToolsSection>
      </div>
